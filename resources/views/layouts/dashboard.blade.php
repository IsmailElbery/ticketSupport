<x-app-layout>
    <div class="flex min-h-screen">
        <div class="bg-indigo-600 px-4 py-2 lg:w-1/4 side_bar">
            ...
            <div class="hidden lg:block">
                <div class="my-2 mb-6">
                    <h1 class="text-2xl font-bold text-white">
                        <img src="https://seu.edu.sa/media/5402/new-logo.png" width="50px" height="50px">
                    </h1>
                </div>
                <ul>
                    <li @class([
                    ...
                    @can('manage groups')
                        <li @class([
                            'mb-2 rounded hover:bg-gray-800 hover:shadow',
                            'bg-gray-800 shadow' => request()->routeIs('groups.*'),
                        ])>
