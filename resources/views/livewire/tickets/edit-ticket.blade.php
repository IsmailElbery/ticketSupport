<div class="max-w-xl">
    <div class="mb-5 text-2xl font-bold">تعديل</div>
    <form wire:submit="save" class="space-y-5">
        ...
        <div>
            <label for="status"
                class="mb-1 block text-sm font-medium text-gray-700 after:ml-0.5 after:text-red-500 after:content-['*']">الحالة</label>
        ...
        @can('manage tickets')
            <div>
                <label for="agents" class="mb-1 block text-sm font-medium text-gray-700">المكلف بها</label>
