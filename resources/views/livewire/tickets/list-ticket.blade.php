<div>
    <x-status />
    <div class="mb-5 text-2xl font-bold">التذاكر</div>
        ...
        <table class="w-full border-collapse bg-white text-left text-sm text-gray-500" style="text-align: center;">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-4 font-medium text-gray-400">مالك التذكرة</th>
                    <th scope="col" class="px-6 py-4 font-medium text-gray-400">الأولوية</th>
