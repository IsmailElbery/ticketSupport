<div class="max-w-xl">
    <div class="mb-5 text-2xl font-bold">إضافة مستخدم</div>
    <form wire:submit="save" class="space-y-5">
        <div>
            <label for="role"
                class="mb-1 block text-sm font-medium text-gray-700 after:ml-0.5 after:text-red-500 after:content-['*']">الدور</label>
        ...
        <div>
            <label for="name"
                class="mb-1 block text-sm font-medium text-gray-700 after:ml-0.5 after:text-red-500 after:content-['*']">الإسم</label>
        ...
        <div>
            <label for="email"
                class="mb-1 block text-sm font-medium text-gray-700 after:ml-0.5 after:text-red-500 after:content-['*']">البريد الإلكتروني</label>
        ...
        <div>
            <label for="password"
                class="mb-1 block text-sm font-medium text-gray-700 after:ml-0.5 after:text-red-500 after:content-['*']">كلمة السر</label>
