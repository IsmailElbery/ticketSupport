<div>
    <div class="mb-5 text-2xl font-bold">الصفحة الرئيسية</div>
    <div class="flex gap-10">
        <div class="w-full max-w-lg rounded-lg bg-white shadow">
            <div class="flex gap-5 p-4">
                ...
                <div>
                    <h3 class="text-lg font-medium text-gray-500">تذاكر مفتوحة</h3>
        ...
        <div class="w-full max-w-lg rounded-lg bg-white shadow">
            <div class="flex gap-5 p-4">
                ...
                <div>
                    <h3 class="text-lg font-medium text-gray-500">تذاكر مغلقة</h3>
